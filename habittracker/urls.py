...
urlpatterns = [
    ...
    path('record/<int:pk>/record/', core_views.add_record_to_habittracker, name='add_record_to_habittracker'),
    path('dailyrecord/<int:pk>/change', core_views.DailyRecordUpdate.as_view(), name='edit_record_to_habittracker'),
